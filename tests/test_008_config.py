...
from piedomains.config import Config, configure, get_config, set_config
...
class TestConfig(unittest.TestCase):
    ...
    def test_default_config_values(self):
        ...
        self.assertEqual(config.get("playwright_timeout"), 30000)
        self.assertEqual(config.get("playwright_headless"), True)
        ...
        self.assertEqual(config.get("max_parallel"), 4)
    ...
    def test_config_properties(self):
        ...
        # Test property access that still exists
        self.assertEqual(
            config.webdriver_timeout, 30
        )  # This should exist as legacy property
    ...
    def test_config_update(self):
        ...
        updates = {"http_timeout": 15, "new_setting": "new_value"}
    ...
    @patch.dict(os.environ, {"PIEDOMAINS_HTTP_TIMEOUT": "invalid_number"})
